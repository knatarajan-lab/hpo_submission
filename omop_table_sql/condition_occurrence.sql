...
SELECT c.[condition_occurrence_id]
  ...
  --This is excluding any events that happened 30 days after the patient died
  where (d.death_date > '2017-07-01' --When CUIMC started to recruit
         and c.condition_start_date <= DATEADD(day, 30, d.death_date)
